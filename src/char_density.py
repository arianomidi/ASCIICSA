...
def getCharDensity(char, font, font_height):
    """
...
def orderChars(chars, font_path=None):
    ...
    try:
        ...
        font_height = font.getsize(ascii_chars)[1]
        left, top, right, bottom = font.getbbox(ascii_chars)
    ...
    char_dict = []
    for c in chars:
        density = getCharDensity(c, font, font_height)
